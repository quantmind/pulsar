...
class Routes(unittest.TestCase):
    ...
    def testSplitRoot(self):
        ...
        self.assertEqual(li, None)
        r = Route('bla')
        p, li = r.split()
        self.assertFalse(p.is_leaf)
        self.assertTrue(li.is_leaf)
        self.assertEqual(p.path, '/')
        self.assertEqual(li.path, '/bla')
        r = Route('bla/')
        p, li = r.split()
        self.assertFalse(p.is_leaf)
        self.assertFalse(li.is_leaf)
        self.assertEqual(p.path, '/')
        self.assertEqual(li.path, '/bla/')
    ...
    def testSplitDir(self):
        ...
        self.assertEqual(li.path, '/pluto/')
