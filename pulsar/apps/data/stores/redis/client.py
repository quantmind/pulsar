...
PyRedisParser = lambda: Parser(InvalidResponse, ResponseError)
...
class Redis(redis.StrictRedis):
    ...
    def pipeline(self, transaction=True, shard_hint=None):
        ...
        """
        return self.store.pipeline(transaction, shard_hint,
    ...
    def pubsub(self, shard_hint=None):
        ...
        '''
        return self.store.pubsub(shard_hint)
...
class Pipeline(BasePipeline, Redis):
    ...
    '''
    def __init__(self, store, transaction, shard_hint,
...
class PubSub(object):
    ...
    def __init__(self, store, shard_hint):
        self.store = store
        self.shard_hint = shard_hint
        self._reset()
