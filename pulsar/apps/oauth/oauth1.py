...
from pulsar.utils.httpurl import iri_to_uri, AuthBase, HTTPError

from .utils import make_nonce, OAuthSignatureMethod_HMAC_SHA1,\
...
'''
    ...
    def __init__(self, id, secret, access_token=None, **kwargs):
    ...
    def fetch_authentication_uri(self, rtoken, callback=None, **kwargs):
        parameters = self.authorisation_parameters(rtoken, callback, **kwargs)
